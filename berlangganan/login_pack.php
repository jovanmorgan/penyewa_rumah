                         ...
                         <div class="auth-box card">
                             <div class="card-block">
                                 ...
                                 <div class="form-group form-primary">
                                     ...
                                     <span class=""><i class="bx bxs-lock-alt" id="toggle-password"
                                             onclick="tombol('password')"
                                             style="cursor: pointer; position: relative; bottom: 40px; left: 370px"></i></span>
                                 ...
                                 <div class="row">
                                     <div class="col-md-10">
                                         ...
                                         <p class="text-inverse text-left"><a href="home"><b>Back to
                                                     website</b></a></p>
                                     </div>
                                     <div class="col-md-2">
