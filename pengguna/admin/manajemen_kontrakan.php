                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h3 class="m-b-12">Manajemen Kontrakan</h3>
                                            <p class="m-b-0"> "Kelola semua properti kontrakan Anda di sini. Tambahkan,
                                                edit, atau hapus informasi kontrakan dengan mudah, serta pantau status
                                                ketersediaan setiap properti."</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                                ...
                                                <div class="container mt-4">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            ...
                                                            <span>Pihak yang penyewa rumah kontrakan atau tempat tinggal
